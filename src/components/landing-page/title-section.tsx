        ...
        <article className=' rounded-full p-[1px] text-sm dark:bg-gradient-to-r dark:from-brand-primaryBlue dark:to-brand-primaryPurple '>
        ...
        </article>
            {
                subheading ? (
                    ...
                    <p className='dark:text-washed-purple-700 sm:min-w-[450px] md:text-center'>{subheading}</p>
                    </>
                ):<h1 className=' text-left text-4xl sm:text-6xl sm:max-w-[850px ] md:text-center md:items-center'>
                    {title}
                </h1>
            }
    </section>
