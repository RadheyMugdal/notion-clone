  ...
  return <header className=" p-4 flex justify-center items-center" >
    ...
    <NavigationMenu className='hidden md:block' >
        <NavigationMenuList className=" gap-6 ">
            <NavigationMenuItem>
              <NavigationMenuTrigger onClick={()=>setPath('#resources')}  className={clsx({
              ...
              <NavigationMenuContent>
                <ul className=" grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                  ...
                  <ListItem href="#" title="Introduction" >
                    Re-usable components built using Redix UI and Tailwind CSS.
                  </ListItem>
            ...
            <NavigationMenuItem>
            <NavigationMenuTrigger onClick={()=>setPath('#pricing')}  className={clsx({
            ...
            <NavigationMenuContent>
              <ul className=" grid w-[400px] gap-3 p-4 md:grid-flow-2 ">
                ...
                <ListItem key={'Free Plan'} title="Free Plan" href="#">
...
const ListItem = React.forwardRef<React.ElementRef<'a'>,React.ComponentPropsWithoutRef<'a'>>(({className,title,children,...props},ref)=>{
  return <li>
    <NavigationMenuLink  asChild>
      <a href="" ref={ref} className={cn(' group block select-none space-y-1 font-medium leading-none')} {...props}>
